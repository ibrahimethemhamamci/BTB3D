...
class VisionTokenizerModule(nn.Module):
    ...
    def decode(self, *args):
        ...
        #print(decoded_pixel_output.max(), "max decoded")
        #print(decoded_pixel_output.min(), "min decoded")
        #decoded_pixel_output = np.clip(decoded_pixel_output.cpu().float().numpy(), -1,1)
        #decoded_pixel_output = torch.tensor(decoded_pixel_output)
        #decoded_pixel_output = decoded_pixel_output.cuda().to(torch.bfloat16)
